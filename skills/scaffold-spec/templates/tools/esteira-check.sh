...
for r in 01-file-size 02-unit-tests 03-solid 04-clean-architecture 05-simplicity \
         ...
         17-integracao-verificada-pelo-cliente 18-loop-de-fundo \
         19-escrita-persistente 20-promessa-sem-mecanismo \
         21-fonte-unica-da-verdade 22-nome-e-lugar 23-dado-do-usuario-na-url; do
